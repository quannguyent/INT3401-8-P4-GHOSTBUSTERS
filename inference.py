...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        particlePositions = [legalPossibleMultiGhostPositions[i % len(legalPossibleMultiGhostPositions)] for i in
        ...
        for particleIndex in range(self.numParticles):
            ...
            for ghostAgent in range(self.numGhosts):
                ...
                if noisyDistances[ghostAgent] == None:
                    self.particles[particleIndex] = self.getParticleWithGhostInJail(self.particles[particleIndex],
                                                                                    ghostAgent)
                else:
